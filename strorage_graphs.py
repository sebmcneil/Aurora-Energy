...
#plt.title("Renewable Wind Generation vs Demand with Transmission Constraints")
...
plt.xlabel("Wind Turbine Expansion Factor")

plt.ylabel("Cost (£)")

plt.title("Feasibility of Wind Turbine Expansion with Storage Costs")
...
plt.title("Net Savings from Wind Turbine Expansion with Storage Costs")
ax = plt.gca()
...
plt.xlabel("Wind Farm Multiplier (x Initial Capacity)")

plt.ylabel("Weeks to Breakeven")

plt.title("Weeks to Breakeven for Wind Farm Expansion (Excluding Initial Multiplier)")
