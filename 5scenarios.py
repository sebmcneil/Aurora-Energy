...
# Set generator ramp rates
def calculate_ramp_rates():
    """Define ramp rates for coal and gas generators."""
    ramp_rates = {
        3: 50,  # Generator 3 ramp rate (MW/hour)
        4: 40,  # Generator 4 ramp rate (MW/hour)
        5: 30,  # Generator 5 ramp rate (MW/hour)
    }
    return ramp_rates
...
def solve_scenario(scenario):
    ...
    # Ramping constraints for coal and gas generators (GEN 3, GEN 4, GEN 5)
    ramp_rates = calculate_ramp_rates()
